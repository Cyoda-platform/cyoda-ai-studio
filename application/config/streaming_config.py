...
class StreamingConfig:
    ...
    CLIENT_TIMEOUT: int = 90   # 1.5 minutes - client-side timeout (shorter than server)
    HEARTBEAT_INTERVAL: int = 30  # 30 seconds - heartbeat frequency
    ...
    CLEANUP_INTERVAL: int = 60   # 1 minute - how often to cleanup old states
    ...
    TCP_KEEPALIVE_IDLE: int = 60    # Start keepalive after 60s of inactivity
    ...
    def from_env(cls) -> 'StreamingConfig':
        ...
        return cls(
            ...
            CLIENT_TIMEOUT=int(os.getenv('CLIENT_TIMEOUT', 90)),
            ...
            MAX_ACCUMULATED_CONTENT=int(os.getenv('MAX_ACCUMULATED_CONTENT', 1024 * 1024)),
