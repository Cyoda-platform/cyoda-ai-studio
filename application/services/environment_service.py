...
class EnvironmentService:
    ...
    async def check_app_status(
        self, user_id: str, env_name: str, app_name: str, auth_token: Optional[str] = None
    ) -> str:
    ...
    async def check_environment_exists(self, user_id: str, env_name: str) -> Dict[str, Any]:
    ...
    async def get_application_status_rollout(self, *args, **kwargs) -> Dict[str, Any]:
        return await self.resource_service.get_application_status_rollout(*args, **kwargs)
    ...
    async def list_user_apps(self, user_id: str, env_name: str, auth_token: Optional[str] = None) -> Dict[str, Any]:
