...
class FileSystemService:
    ...
    def _decode_bytes(self, data: bytes) -> str:
        ...
        """
        return (
            data.decode(DEFAULT_ENCODING, errors=ENCODING_ERROR_HANDLER) if data else ""
        )
    ...
    def _build_success_summary(self, stdout: str) -> Dict[str, Any]:
        ...
        return {"output_lines": len(stdout_lines), "has_output": bool(stdout.strip())}
    ...
    async def execute_unix_command(
        self, command: str, repo_path: Path
    ) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.error(
                COMMAND_EXECUTION_ERROR.format(command=command, error=e), exc_info=True
            )
    ...
    def validate_command_security(self, command: str) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                "safe": False,
                "reason": INVALID_COMMAND_SYNTAX_ERROR.format(error=e),
            }
