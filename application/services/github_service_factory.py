...
class GitHubServiceFactory:
    ...
    def create_for_public_repo(
        ...
        if token:
            ...
            logger.info(f"Creating GitHub service for public repo with personal access token")
    ...
    def create_with_token(
        ...
        """
        logger.info(f"Creating GitHub service with personal access token (owner={owner or GH_DEFAULT_OWNER})")
