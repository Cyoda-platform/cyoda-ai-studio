...
class GitHubAppJWTGenerator:
    ...
    def __init__(
        ...
        if not self.app_id:
            raise ValueError("GitHub App ID is required. Set GITHUB_APP_ID in environment.")

        if not self.private_key_path:
            raise ValueError("GitHub App private key path is required. Set GITHUB_APP_PRIVATE_KEY_PATH in environment.")
