...
from application.services.github.models.types import CollaboratorInfo, GitHubPermission
...
class CollaboratorOperations:
    ...
    async def add_collaborator(
        ...
        logger.info(
            f"Added collaborator {username} to {owner}/{repository_name} with {permission.value} permission"
        )
    ...
    async def remove_collaborator(
        self, username: str, repository_name: str, owner: Optional[str] = None
    ) -> bool:
