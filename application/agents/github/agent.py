...
from application.agents.build_app.tools import (
    clone_repository,
...
def _get_model_config() -> LiteLlm:
    """Get model configuration for GitHub agent."""
...
root_agent = LlmAgent(
    ...
    instruction=create_instruction_provider("github_agent"),
    tools=tools,
)
