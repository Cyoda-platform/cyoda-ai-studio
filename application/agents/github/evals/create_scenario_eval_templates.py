#!/usr/bin/env python3
"""Create eval template files from scenarios.md.

This script creates empty eval template files that can be run with `adk eval`
to generate actual responses.
"""
...
def main():
    ...
    print(f"     application/agents/github/evals/scenarios/*.evalset.json \\")
    print(f"     --config_file_path application/agents/tests/evals/test_config.json\n")
    print("2. Or run a script to update expected values after running:")
    print(f"\n   python application/agents/tests/evals/update_expected_values.py \\")
    print(f"     application/agents/.adk/eval_history/*github_scenario*.json\n")
