...
async def check_environment_exists(tool_context: ToolContext) -> str:
    ...
    Returns:
        JSON string with environment status:
        - {"exists": true, "url": "https://...", "message": "..."} if environment exists
        - {"exists": false, "url": "https://...", "message": "..."} if environment doesn't exist
    """
    try:
...
async def deploy_cyoda_environment(
    ...
    try:
        ...
        with httpx.Client(timeout=60.0) as client:
            ...
            response = client.post(deploy_url, json=payload, headers=headers)
