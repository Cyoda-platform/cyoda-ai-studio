...
root_agent = LlmAgent(
    ...
    description="Cyoda setup guidance specialist. Helps users understand the setup process and connects them with specialized agents for code analysis, deployment, and credentials.",
