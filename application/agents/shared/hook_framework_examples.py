...
def example_tool_decoration() -> None:
    ...
    from application.agents.shared.hook_decorator import (
        creates_hook,
        get_tool_hooks,
    )
...
def example_prompt_helper() -> None:
    ...
    from application.agents.shared.prompt_hook_helper import (
...
def example_test_hooks() -> None:
    ...
    from application.agents.shared.hook_factory import (
        HookValidationError,
        get_hook_factory,
    )
