...
class DocumentationFetcher:
        ...
        try:
            ...
            for line in lines:
                ...
                if any(skip in line.lower() for skip in [
                    'skip to content', 'search', 'menu', 'navigation',
                    'cookie', 'all rights reserved', '© 20'
                ]):
                    continue
    ...
    def generate_full_docs_txt(
        ...
        output.append("")
        output.append("The following documentation provides comprehensive guides and references.")
        output.append("")

        # Organize pages by category
        categorized_pages = {key: [] for key in categories.keys()}

        print(f"Fetching content from {min(self.max_pages, len(self.urls))} documentation pages...")
