...
class TestUpdateTask:
    ...
    async def test_update_task_success_first_attempt(self):
        ...
        with patch(
            "application.services.task_service.BackgroundTask", return_value=task
        ):
    ...
    async def test_update_task_with_version_conflict_retry(self):
        ...
        entity_service.update = AsyncMock(
            side_effect=[Exception("422 version mismatch"), success_response]
        )
