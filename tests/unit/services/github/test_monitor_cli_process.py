...
class TestMonitorCliProcess:
    ...
    @pytest.mark.asyncio
    async def test_monitor_cli_process_with_valid_parameters(
        self, cli_service, mock_process
    ):
    ...
    @pytest.mark.asyncio
    async def test_monitor_cli_process_timeout_handling(
        self, cli_service, mock_process
    ):
    ...
    @pytest.mark.asyncio
    async def test_monitor_cli_process_successful_completion(
        self, cli_service, mock_process
    ):
    ...
    @pytest.mark.asyncio
    async def test_monitor_cli_process_failed_completion(
        self, cli_service, mock_process
    ):
    ...
    @pytest.mark.asyncio
    async def test_monitor_cli_process_with_conversation_id(
        self, cli_service, mock_process
    ):
