...
class TestPullInternal:
    ...
    async def test_pull_internal_no_changes(self):
        ...
        with patch.object(git_ops, '_ensure_branch_exists') as mock_ensure:
            ...
            with patch('asyncio.create_subprocess_exec') as mock_subprocess:
                ...
                mock_subprocess.side_effect = [fetch_process, diff_process, merge_process, extra_process, extra_process, extra_process]
    ...
    async def test_pull_internal_fetch_failure(self):
        ...
        with patch.object(git_ops, '_ensure_branch_exists') as mock_ensure:
            ...
            with patch('asyncio.create_subprocess_exec') as mock_subprocess:
                ...
                fetch_process.communicate = AsyncMock(return_value=(b"", b"Fetch failed"))
    ...
    async def test_pull_internal_with_changes(self):
        ...
        with patch.object(git_ops, '_ensure_branch_exists') as mock_ensure:
            mock_ensure.return_value = GitOperationResult(success=True, message="Branch exists")
            ...
            with patch('asyncio.create_subprocess_exec') as mock_subprocess:
                ...
                diff_process = AsyncMock()
                diff_process.returncode = 0
                diff_process.communicate = AsyncMock(return_value=(b"diff content", b""))
