...
class TestGenerateResponse:
    ...
    async def test_generate_response_success(self):
        ...
        service._build_messages = MagicMock(return_value=[{"role": "user", "content": "test"}])
    ...
    async def test_generate_response_with_context(self):
        ...
        service._build_messages = MagicMock(return_value=context + [{"role": "user", "content": "test"}])
    ...
    async def test_generate_response_uses_build_messages(self):
        ...
        assert result == "Response"
        service._build_messages.assert_called_once_with("test prompt", context, system_instruction)
